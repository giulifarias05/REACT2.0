    ...
    <div className="container d-flex justify-content-center align-items-center vh-100">
      <div className="card card-container">
        ...
        <div className="card-body">
          ...
          <p className="card-text">Como contenido o tecnologías que considero saber usar y que tengo aprendidos serian: Javascript, express, css, base de datos, node js, etc...</p>
        </div>
      </div>
    </div>
